...
lat = [position[number-1].get_lat(),position[number].get_lat(),position[number+1].get_lat()]
long = [position[number-1].get_long(),position[number].get_long(),position[number+1].get_long()    ]
